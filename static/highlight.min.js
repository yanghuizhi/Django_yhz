...
!function (e) {
    ...
    var u = [], s = Object.keys, w = {}, b = {}, x = !0, t = /^(no-?highlight|plain|text)$/i,
        p = /\blang(?:uage)?-([\w-]+)\b/i, r = /((^(<[^>]+>|\t|)+|(?:\n)))/gm, a = {
            case_insensitive: "cI",
            lexemes: "l",
            contains: "c",
            keywords: "k",
            ...
            terminators: "t",
            terminator_end: "tE"
        }, k = "</span>", E = "Could not find the language '{}', did you forget to load/include a language module?",
    ...
    function o(t) {
        ...
        }(t) ? [i(t, {starts: t.starts ? i(t.starts) : null})] : Object.isFrozen(t) ? [i(t)] : [t]
    }
    ...
    function B(a) {
        ...
        function n(n) {
            ...
            return i = u(function (e, t) {
                ...
                var r = i.exec(e);
                if (!r) return null;
                for (var a = 0; a < r.length; a++) if (null != r[a] && null != s["" + a]) {
                    t = s["" + a];
                    break
                }
    ...
    function R(t, e, n, r) {
        ...
        function o(e) {
            g += e.cN ? c(e.cN, "", !0) : "", f = Object.create(e, {parent: {value: f}})
        }
        ...
        function d(e) {
            var t = e[0], r = i.substr(e.index), a = function e(t, r) {
        ...
        try {
            ...
            if (e.message && -1 !== e.message.indexOf("Illegal")) return {i: !0, relevance: 0, value: C(i)};
            if (x) return {relevance: 0, value: C(i), language: t, top: f, errorRaised: e};
            throw e
        }
    }
    ...
    function S(r, e) {
        e = e || M.languages || s(w);
        var a = {relevance: 0, value: C(r)}, n = a;
    ...
    function d(e) {
        var t, r, a, n, i, s, c, o, l, d, u = function (e) {
            ...
            for (t = 0, a = (i = i.split(/\s+/)).length; t < a; t++) if (m(n = i[t]) || A(n)) return n
        }(e);
    ...
    return n.highlight = R, n.highlightAuto = S, n.fixMarkup = v, n.highlightBlock = d, n.configure = function (e) {
        ...
        return a.c.push(n.PWM), a.c.push({cN: "doctag", b: "(?:TODO|FIXME|NOTE|BUG|XXX):", relevance: 0}), a
    }, n.CLCM = n.C_LINE_COMMENT_MODE = n.C("//", "$"), n.CBCM = n.C_BLOCK_COMMENT_MODE = n.C("/\\*", "\\*/"), n.HCM = n.HASH_COMMENT_MODE = n.C("#", "$"), n.NM = n.NUMBER_MODE = {
        cN: "number",
        b: n.NR,
        relevance: 0
    }, n.CNM = n.C_NUMBER_MODE = {cN: "number", b: n.CNR, relevance: 0}, n.BNM = n.BINARY_NUMBER_MODE = {
        cN: "number",
        b: n.BNR,
        relevance: 0
    ...
    }, n.TM = n.TITLE_MODE = {cN: "title", b: n.IR, relevance: 0}, n.UTM = n.UNDERSCORE_TITLE_MODE = {
        cN: "title",
        b: n.UIR,
        relevance: 0
    }, n.METHOD_GUARD = {
        ...
        var t = {
            ...
            n = [e.BNM, e.inherit(e.CNM, {starts: {e: "(\\s*/)?", relevance: 0}}), {
                cN: "string",
        ...
        return {
            ...
            c: n.concat([e.C("###", "###"), e.HCM, {
                ...
                rB: !0,
                c: [i, c]
            }, {b: /[:\(,=]\s*/, relevance: 0, c: [{cN: "function", b: s, e: "[-=]>", rB: !0, c: [c]}]}, {
                cN: "class",
                bK: "class",
                e: "$",
                i: /[:="\[\]]/,
        ...
        var r = "decltype\\(auto\\)", a = "[a-zA-Z_]\\w*::",
            n = (t(a), t("<.*?>"), {cN: "keyword", b: "\\b[a-z\\d_]*_t\\b"}), i = {
                cN: "string",
                v: [{
                    b: '(u8?|U|L)?"',
                    e: '"',
                ...
                c: [{b: /\\\n/, relevance: 0}, e.inherit(i, {cN: "meta-string"}), {
                    cN: "meta-string",
                    b: /<.*?>/,
                    e: /$/,
                    i: "\\n"
                }, e.CLCM, e.CBCM]
            }, o = {cN: "title", b: t(a) + e.IR, relevance: 0}, l = t(a) + e.IR + "\\s*\\(", d = {
            ...
            }, u = [n, e.CLCM, e.CBCM, s, i], b = {
                v: [{b: /=/, e: /;/}, {b: /\(/, e: /\)/}, {bK: "new throw return else", e: /;/}],
                k: d,
                c: u.concat([{b: /\(/, e: /\)/, k: d, c: u.concat(["self"]), relevance: 0}]),
                relevance: 0
            }, p = {
                cN: "function",
                ...
                k: d,
                i: /[^\w\s\*&:<>]/,
                c: [{b: r, k: d, relevance: 0}, {b: l, rB: !0, c: [o], relevance: 0}, {
                    cN: "params",
                    b: /\(/,
                    e: /\)/,
                    k: d,
        ...
        var d = {v: [o, c, a, e.ASM, e.QSM]}, u = e.IR + "(<" + e.IR + "(\\s*,\\s*" + e.IR + ")*>)?(\\[\\])?";
        return {
            aliases: ["csharp", "c#"],
            k: t,
            i: /::/,
            ...
            }, d, r, {bK: "class interface", e: /[{;=]/, i: /[^\s:,]/, c: [e.TM, e.CLCM, e.CBCM]}, {
                bK: "namespace",
                e: /[{;=]/,
                i: /[^\s:]/,
        ...
        var t = {cN: "number", relevance: 0, v: [{b: /([\+\-]+)?[\d]+_[\d_]+/}, {b: e.NR}]}, r = e.C();
        r.v = [{b: /;/, e: /$/}, {b: /#/, e: /$/}];
        var a = {cN: "variable", v: [{b: /\$[\w\d"][\w\d_]*/}, {b: /\$\{(.*?)}/}]},
            n = {cN: "literal", b: /\bon|off|true|false|yes|no\b/}, i = {
                cN: "string",
                c: [e.BE],
        ...
        return {
            ...
            c: [r, {cN: "section", b: /\[+/, e: /\]+/}, {
                b: /^[a-z0-9\[\]_\.-]+(?=\s*=\s*)/,
                cN: "attr",
                starts: {e: /$/, c: [r, {b: /\[/, e: /\]/, c: [r, n, a, i, t, "self"], relevance: 0}, n, a, i, t]}
            }]
        }
        ...
        var t = "<>", r = "</>", a = {b: /<[A-Za-z0-9\\._:-]+/, e: /\/[A-Za-z0-9\\._:-]+>|\/>/},
            ...
            o = {b: "html`", e: "", starts: {e: "`", rE: !1, c: [e.BE, c], sL: "xml"}},
            l = {b: "css`", e: "", starts: {e: "`", rE: !1, c: [e.BE, c], sL: "css"}},
        ...
        return {
            ...
            c: [{cN: "meta", relevance: 10, b: /^\s*['"]use (strict|asm)['"]/}, {
                ...
                b: /[{,\n]\s*/,
                relevance: 0,
                c: [{b: n + "\\s*:", rB: !0, relevance: 0, c: [{cN: "attr", b: n, relevance: 0}]}]
            }, {
                ...
                c: [e.CLCM, e.CBCM, e.RM, {
                    ...
                    rB: !0,
                    e: "\\s*=>",
                    c: [{cN: "params", v: [{b: n}, {b: /\(\s*\)/}, {b: /\(/, e: /\)/, eB: !0, eE: !0, k: i, c: u}]}]
                }, {cN: "", b: /\s/, e: /\s*/, skip: !0}, {
                    v: [{b: t, e: r}, {b: a.b, e: a.e}],
                    sL: "xml",
                ...
                e: /\{/,
                eE: !0,
                c: [e.inherit(e.TM, {b: n}), {cN: "params", b: /\(/, e: /\)/, eB: !0, eE: !0, c: u}],
                i: /\[|%/
            }, {b: /\$[(.]/}, e.METHOD_GUARD, {
                cN: "class",
                bK: "class",
        ...
        var t = {literal: "true false null"}, r = [e.CLCM, e.CBCM], a = [e.QSM, e.CNM],
            n = {e: ",", eW: !0, eE: !0, c: a, k: t}, i = {
                b: "{",
                e: "}",
                c: [{cN: "attr", b: /"/, e: /"/, c: [e.BE], i: "\\n"}, e.inherit(n, {b: /:/})].concat(r),
                i: "\\S"
        ...
        var t = {
            ...
            }, r = {cN: "symbol", b: e.UIR + "@"}, a = {cN: "subst", b: "\\${", e: "}", c: [e.CNM]},
            n = {cN: "variable", b: "\\$" + e.UIR}, i = {
                cN: "string",
                v: [{b: '"""', e: '"""(?=[^"])', c: [n, a]}, {b: "'", e: "'", i: /\n/, c: [e.BE]}, {
                    b: '"',
                    e: '"',
        ...
        }, c = {cN: "meta", b: "@" + e.UIR, c: [{b: /\(/, e: /\)/, c: [e.inherit(i, {cN: "meta-string"})]}]}, o = {
            cN: "number",
            b: "\\b(0[bB]([01]+[01_]+[01]+|[01]+)|0[xX]([a-fA-F0-9]+[a-fA-F0-9_]+[a-fA-F0-9]+|[a-fA-F0-9]+)|(([\\d]+[\\d_]+[\\d]+|[\\d]+)(\\.([\\d]+[\\d_]+[\\d]+|[\\d]+))?|\\.([\\d]+[\\d_]+[\\d]+|[\\d]+))([eE][-+]?\\d+)?)[lLfF]?",
            relevance: 0
        }, l = e.C("/\\*", "\\*/", {c: [e.CBCM]}), d = {v: [{cN: "type", b: e.UIR}, {b: /\(/, e: /\)/, c: []}]}, u = d;
        return u.v[1].c = [d], d.v[1].c = [u], {
            aliases: ["kt"],
            k: t,
            c: [e.C("/\\*\\*", "\\*/", {relevance: 0, c: [{cN: "doctag", b: "@[A-Za-z]+"}]}), e.CLCM, l, {
                cN: "keyword",
                ...
                c: [{b: e.UIR + "\\s*\\(", rB: !0, relevance: 0, c: [e.UTM]}, {
                    ...
                    k: t,
                    relevance: 0,
                    c: [{b: /:/, e: /[=,\/]/, eW: !0, c: [d, e.CLCM, l], relevance: 0}, e.CLCM, l, s, c, i, e.CNM]
                }, l]
            }, {
                cN: "class",
                ...
                c: [{bK: "public protected internal private constructor"}, e.UTM, {
                    ...
                    eE: !0,
                    relevance: 0
                }, {cN: "type", b: /[,:]\s*/, e: /[<\(,]|$/, eB: !0, rE: !0}, s, c]
            }, i, {cN: "meta", b: "^#!/usr/bin/env", e: "$", i: "\n"}, o]
        }
        ...
        var a = "[\\w-]+", n = "(" + a + "|@{" + a + "})", i = [], s = [], c = {b: "\\(", e: "\\)", c: s, relevance: 0};
        ...
        var o = s.concat({b: "{", e: "}", c: i}), l = {bK: "when", eW: !0, c: [{bK: "and not"}].concat(s)}, d = {
            b: n + "\\s*:",
            rB: !0,
            e: "[;}]",
            relevance: 0,
            c: [{cN: "attribute", b: n, e: ":", eE: !0, starts: {eW: !0, i: "[<=$]", relevance: 0, c: s}}]
        }, u = {
            cN: "keyword",
        ...
        return i.push(e.CLCM, e.CBCM, u, b, d, p), {cI: !0, i: "[=>'/<($\"]", c: i}
    }), n.registerLanguage("lua", function (e) {
        var t = "\\[=*\\[", r = "\\]=*\\]", a = {b: t, e: r, c: ["self"]},
            n = [e.C("--(?!" + t + ")", "$"), e.C("--" + t, r, {c: [a], relevance: 10})];
        return {
            l: e.UIR,
            k: {
            ...
            }, e.CNM, e.ASM, e.QSM, {cN: "string", b: t, e: r, c: [a], relevance: 5}])
        }
        ...
        var t = {cN: "variable", v: [{b: "\\$\\(" + e.UIR + "\\)", c: [e.BE]}, {b: /\$[@%<?\^\+\*]/}]},
            r = {cN: "string", b: /"/, e: /"/, c: [e.BE, t]}, a = {
                ...
                c: [t]
            }, n = {b: "^" + e.UIR + "\\s*(?=[:+?]?=)"}, i = {cN: "section", b: /^[^\s]+:/, e: /$/, c: [t]};
        return {
            aliases: ["mk", "mak"],
        ...
        var t = {cN: "symbol", b: "&[a-z]+;|&#[0-9]+;|&#x[a-f0-9]+;"},
            r = {b: "\\s", c: [{cN: "meta-keyword", b: "#?[a-z_][a-z1-9_-]+", i: "\\n"}]},
            a = e.inherit(r, {b: "\\(", e: "\\)"}), n = e.inherit(e.ASM, {cN: "meta-string"}),
            i = e.inherit(e.QSM, {cN: "meta-string"}), s = {
                eW: !0,
                i: /</,
                relevance: 0,
        ...
        return {
            ...
            c: [{
                ...
                e: ">",
                relevance: 10,
                c: [r, i, n, a, {b: "\\[", e: "\\]", c: [{cN: "meta", b: "<![a-z]", e: ">", c: [r, a, i, n]}]}]
            }, e.C("\x3c!--", "--\x3e", {relevance: 10}), {
                b: "<\\!\\[CDATA\\[",
                e: "\\]\\]>",
                relevance: 10
            }, t, {cN: "meta", b: /<\?xml/, e: /\?>/, relevance: 10}, {
                b: /<\?(php)?/,
                e: /\?>/,
                sL: "php",
        ...
        return {
            ...
            c: [e.HCM, {
                ...
                relevance: 0
            }, {b: e.UIR + "\\s", e: ";|{", rB: !0, c: [{cN: "attribute", b: e.UIR, starts: r}], relevance: 0}],
            i: "[^\\s\\}]"
        }
        ...
        var t = {
            ...
            }, r = {cN: "meta", b: /^(>>>|\.\.\.) /}, a = {cN: "subst", b: /\{/, e: /\}/, k: t, i: /#/},
            n = {b: /\{\{/, relevance: 0}, i = {
                cN: "string",
                c: [e.BE],
                v: [{b: /(u|b)?r?'''/, e: /'''/, c: [e.BE, r], relevance: 10}, {
                    b: /(u|b)?r?"""/,
                    e: /"""/,
                    c: [e.BE, r],
                    relevance: 10
                    ...
                    b: /(b|br)'/,
                    e: /'/
                }, {b: /(b|br)"/, e: /"/}, {b: /(fr|rf|f)'/, e: /'/, c: [e.BE, n, a]}, {
                    b: /(fr|rf|f)"/,
                    e: /"/,
                    c: [e.BE, n, a]
                }, e.ASM, e.QSM]
        ...
        return a.c = [i, s, r], {
            ...
            k: t,
            i: /(<\/|->|\?)|=>/,
            c: [r, s, {bK: "if", relevance: 0}, i, e.HCM, {
        ...
        var t = {
            ...
            }, r = e.C("/\\*", "\\*/", {c: ["self"]}), a = {cN: "subst", b: /\\\(/, e: "\\)", k: t, c: []},
            n = {cN: "string", c: [e.BE, a], v: [{b: /"""/, e: /"""/}, {b: /"/, e: /"/}]}, i = {
                cN: "number",
        ...
        return a.c = [i], {
            k: t,
            c: [n, e.CLCM, r, {cN: "type", b: "\\b[A-Z][\\wÀ-ʸ']*[!?]"}, {
                cN: "type",
                b: "\\b[A-Z][\\wÀ-ʸ']*",
                relevance: 0
            }, i, {
        ...
        var t = "[A-Za-z$_][0-9A-Za-z$_]*", r = {
            ...
            i = {cN: "params", b: /\(/, e: /\)/, eB: !0, eE: !0, k: r, c: [e.CLCM, e.CBCM, a, n]}, s = {
                cN: "number",
                v: [{b: "\\b(0[bB][01]+)n?"}, {b: "\\b(0[oO][0-7]+)n?"}, {b: e.CNR + "n?"}],
                relevance: 0
        ...
        return c.c = [e.ASM, e.QSM, o, l, d, s, e.RM], {
            ...
            c: [{
                ...
                eE: !0,
                k: "interface extends"
            }, {b: /\$[(.]/}, {b: "\\." + e.IR, relevance: 0}, a, n]
        }
    }), n.registerLanguage("yaml", function (e) {
        var t = "true false yes no null", r = {
            cN: "string",
            relevance: 0,
            v: [{b: /'/, e: /'/}, {b: /"/, e: /"/}, {b: /\S+/}],
        ...
        return {
            ...
            c: [{
                ...
                cN: "meta",
                b: "\\*" + e.UIR + "$"
            }, {cN: "bullet", b: "\\-(?=[ ]|$)", relevance: 0}, e.HCM, {bK: t, k: {literal: t}}, {
                cN: "number",
                b: e.CNR + "\\b"
            }, r]
        }
